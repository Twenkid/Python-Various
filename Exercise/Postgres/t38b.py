...
#postgre ...
#t38.py log.txt, Postgre, acsh, logs - send to DB, ... 12/5/2015, 13/5/2015, 14/5/2015 ...
...
def readsend(path):
	conn = None
	try:         
		conn = psycopg2.connect(database='twenkid_config', user='postgres', password='02012014') 
		cur = conn.cursor()
