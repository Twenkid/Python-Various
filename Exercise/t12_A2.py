...
def numbersB(w,x,y,wc):
  ...
  for y1 in range(y):
    ...
    for x1 in range(x+1):    
      ...
      #print(r"""<center><span style="font-size: 100%; color: black">"""+str(c)+"</span></center><br><br>\n\n\n") #<b></b>
      print(r"""<center><span style="font-size: 120%; color: black">"""+r"""<a href="#""" +  str(c) + "\">" + str(c) + r"""</a>""""</span></center>\n\n\n") #<b></b>  #<br>
      print("</td>")
      c+=1
  print("</tr>")
  print(r"</table>")
...
numbersB(w=1150, x=20, y=31, wc=15)
divA(1150, "Consolas", 14)
articles(0,900)
