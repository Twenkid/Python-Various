...
#Тодор Арнаудов - Тош, Разумир, Razumir, Twenkid, Tosh... 22-3-2016
#t9_zrim1.py

def walkExample(path):		#  @  \|/ ({K}!({пП}) ... -*- обПмт.&[1] ...  (,нч)   ... 
	import os				#  @  -*-{К-К}("os") 
	for root, dirs, files in os.walk(path, topdown=False):	# Обх.свеждане.{бр[.].вт=3(&[.]1 = "root", &[.]2 = "dirs", &[.]3="files"; &[.].вн = (!="os.walk", !.#=(&[.]1 = "path" = ОбПмт.&[1], &[.]2 = "topdown=False".свеждане)) (,нч)
	# &[.]1 = "root" -*- пмт.&[1], ...
